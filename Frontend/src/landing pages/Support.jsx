    ...
    <div className="lg:mt-[9vh]">
      ...
      <div className="mainpad py-[1rem] flex md:justify-between lg:flex-row flex-col gap-3">
        ...
        <div className="md:w-[28%] flex flex-col gap-7 md:mt-[2.4rem]">
          ...
          <div className="w-[100%]">
            <table className="font-all w-[100%] support">
              <thead>
                <tr>
                  <th className="text-gray-700 bg-gray-200 p-3 text-start support">Quick Links</th>
                </tr>
              </thead>
              <tbody>
                <tr><td className="support">1.Track account opening</td></tr>
                <tr><td className="support">2.Track segment activation</td></tr>
                <tr><td className="support">3.Intraday margins</td></tr>
                <tr><td className="support">3.Intraday margins</td></tr>
                <tr><td className="support">5.Learn how to create a ticket</td></tr>
              </tbody>
            </table>
          </div>
        </div>
